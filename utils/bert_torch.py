...
def load_tf_weights_in_bert(model, config, tf_checkpoint_path):
    ...
    for name, array in zip(names, arrays):
        ...
        if any(
                n in ["adam_v", "adam_m", "AdamWeightDecayOptimizer", "AdamWeightDecayOptimizer_1", "global_step", "output_bias", "output_weights", "output_bias_cls", "output_weights_cls" ]
                for n in name
        ):
        ...
        for m_name in name:
            ...
            if len(scope_names) >= 2:
                ...
                pointer = pointer[num]
        if m_name[-11:] == "_embeddings" or m_name[-13:] == "_embeddings_0" or m_name[-13:] == "_embeddings_1" \
                or m_name[-13:] == "_embeddings_2" or m_name[-13:] == "_embeddings_3" or m_name[-13:] == "_embeddings_4" \
                or m_name[-13:] == "_embeddings_5" or m_name[-13:] == "_embeddings_6":
            pointer = getattr(pointer, "weight")
        elif m_name == "kernel":
...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        #"segment_ids", "column_ids", "row_ids", "prev_label_ids", "column_ranks", "inv_column_ranks", "numeric_relations"
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        embeddings = inputs_embeds + position_embeddings + token_type_embeddings_0 + token_type_embeddings_1 + \
                     token_type_embeddings_2 + token_type_embeddings_3 + token_type_embeddings_4 + \
                     token_type_embeddings_5 + token_type_embeddings_6
